                    ...
                    <Wrapper>
                        ...
                        <InputContainer>
                            ...
                            <UploadButton variant="contained" component="span">
                                ...
                                {profile.displayPicture ? <ProfileImage alt="profile" src={profile.displayPicture} /> : <FaceIcon />}

                            </UploadButton>
                            {uploadFile && typeof (uploadFile) !== "undefined"
                                ?
                                <Button variant="contained" onClick={() => uploadImage(uploadFile, navigate)}>
                                    Save
                                </Button>
                                :
                                null
                        ...
                        <div>Address :
                            {
                                editAdd ?
                                    <Wrapper>
                                        ...
                                        <Cancel color="error" variant="contained" onClick={() => setEditAdd(editAdd => !editAdd)} >Cancel</Cancel>
                                    </Wrapper>
                                    :
                                    <div>
                                        <div>
                                                    ...
                                                    <>
                                                        {!editAddress ?
                                                            <AddressItem key={item._id}>
                                                                <Info key={index}>{item.addressLine1},{item.addressLine2}</Info>
                                                                <Info key={index}>{item.city},{item.country}</Info>
                                                                {/* <p key={index}>{item.country_code}</p> */}
                                                                <Info key={index}>{item.post_code}</Info>
                                                                <Button variant="contained" color="error" onClick={() => deleteAddress(item._id, navigate)} >Delete</Button>
                                                            ...
                                                            <Wrapper>
                                                                ...
                                                                <Cancel color="error" variant="contained" onClick={() => window.location.reload()} >Cancel</Cancel>
                                                            </Wrapper>
                                                        }
                                                        <hr /></>
                                                )
...
const EditProfie = ({ setEditAdd, setEditAddress, id, navigate, addLine1, addLine2, addCity, addPost_code, addCountry, addCountry_code, addMobile }) => {
    ...
    return (
        <Form onSubmit={(e) => submitAddress(e)}>
            <TextField id="outlined-basic" label="Address Line1" variant="standard" name="addressLine1" value={addressLine1} required onChange={e => setAddressLine1(e.target.value)} />
            <TextField id="outlined-basic" label="Address Line2" variant="standard" name="addressLine2" value={addressLine2} required onChange={e => setAddressLine2(e.target.value)} />
            <TextField id="outlined-basic" label="City" variant="standard" name="city" value={city} required onChange={e => setCity(e.target.value)} />
            <TextField id="outlined-basic" label="Post Code" variant="standard" name="post_code" value={post_code} required onChange={e => setPost_code(e.target.value)} />
            <TextField id="outlined-basic" label="Country" variant="standard" name="country" value={country} required onChange={e => setCountry(e.target.value)} />
            <TextField id="outlined-basic" label="Country code" variant="standard" name="country_code" inputProps={{ pattern: "[A-Za-z]{3}" }} value={country_code} required onChange={e => setCountry_code(e.target.value)} />
            <TextField id="outlined-basic" label="Mobile" variant="standard" name="mobile" type="tel" value={mobile} inputProps={{ pattern: "[1-9]{1}[0-9]{9}" }} onChange={e => setMobile(e.target.value)} />
